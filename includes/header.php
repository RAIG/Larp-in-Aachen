	...
	<div class="navbar navbar-fixed-top">
	    <div class="navbar-inner">
	      <div class="container">
	        ...
	        <a class="brand" href="index.php">Larp in Aachen</a>
	...
	<div class="title-bar">
		<div class="container">
			<div class="row">
				<div class="span12">
					<div class="picture">
						<img src="/img/<?php if ( isset( $banner ) ) { echo $banner; } else { echo "index_banner.jpg"; } ?>" width="940" height="200"/>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="subtitle-bar">
		<div class="container">	
			<div class="row">
				<div class="span12">
					<div class="center">
						<p><span class="label label-warning">Beta</span> Die Webpräsenz der Raigländer Söldner befindet sich noch im Aufbau. Der Inhalt wird mit und mit an das neue Design angepasst und eingepflegt.</p>
					</div>
				</div>
			</div>
		</div>
	</div>
	<div class="subsubtitle-bar">
		<div class="container">	
			<div class="row">
				<div class="span12">
